...
```html
<div data-pym-src="https://static.startribune.com/news/projects/all/20190630-crp">Loading...</div>
...
```js
{
  "publish": {
    "default": {
      ...
      "path": "news/projects-staging/all/20190630-crp/",
      "url": "http://static.startribune.com/news/projects-staging/all/20190630-crp/"
    },
    "production": {
      "bucket": "static.startribune.com",
      "path": "news/projects/all/20190630-crp/",
      "url": "http://static.startribune.com/news/projects/all/20190630-crp/"
    }
  }
}
```
