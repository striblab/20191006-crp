...
import nilfMN from '../sources/change_mn.json';
...
class Map {
    ...
    constructor(target) {
        ...
        this.colorScale = d3.scaleLinear().domain([-1,-0.5,-0.1,0,0.1,0.5,1]).range(['#C2421F', '#F2AF80', '#F2D2A4', '#CCCCCC', '#A7E6E3', '#67B4C2', '#3580A3']);
    }
    ...
    render() {
        ...
        g.append("g")
            ...
            .style("fill", function(d) {
                ...
                for (var i=0; i < dataMN.length; i++) {
                    ...
                    if (dataMN[i].NAME == d.properties.COUNTYNAME) {
                        ...
                        return self.colorScale(dataMN[i].CHANGE);
                    }
                }
            ...
            .call(tooltip(function(d, i) {
                ...
                for (var i = 0; i < dataMN.length; i++) {
                    if (dataMN[i].NAME == d.properties.COUNTYNAME) {
                        var points = dataMN[i].CHANGE;
                        var pct = dataMN[i].CHANGE;
                        return "<div class='countyName'>" + d.properties.COUNTYNAME + "</div><div class='number'><span class='legendary' style='background-color:" + self.colorScale(points) + ";'>" + d3.format("+.0%")(pct) + "</span> change in acreage from 2007</div>"
                    }
                }
              }));
